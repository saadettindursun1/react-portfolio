      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-6 img md-mb50">
            <img src="/img/portfolio/project/saadettin-dursun-proje-yarismasi.png" alt="" />
          </div>
          <div className="col-lg-5 valign">
            <div className="cont full-width">
              <h3 className="color-font">Web Developer</h3>
              <h5 className="co-tit mb-15">
              Çeşitli teknolojileri kullanarak web siteleri oluşturuyorum.
              </h5>
              <p>
               İsteğinize göre e-ticaret siteleri, yönetim panelli siteler , blog siteleri, portfolio siteleri ve kurumsal siteler yapıyorum.
              </p>
              <div className="skills-box mt-40">
                <div className="skill-item">
                  <h5 className="fz-14 mb-15">Backend Geliştirme</h5>
                  <div className="skill-progress">
                    <div className="progres" data-value="80%"></div>
                  </div>
                </div>
                <div className="skill-item">
                  <h5 className="fz-14 mb-15">Frontend Geliştirme</h5>
                  <div className="skill-progress">
